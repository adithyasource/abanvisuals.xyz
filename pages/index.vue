...
<template>
  <div
    ...
    <div>
      <p
        class="font-monument tracking-wider text-[44px] text-transparent bg-clip-text bg-gradient-to-b from-[#40EE97] to-[#3AF5C2]">
        MOHAMMED ABAN
      </p>
      <p>
        ...
        ">
          <div class="flex flex-row gap-2 cursor-pointer">
            <svg
              ...
              viewBox="0 0 256 256">
              <path
                d="M224,48H32a8,8,0,0,0-8,8V192a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A8,8,0,0,0,224,48ZM203.43,64,128,133.15,52.57,64ZM216,192H40V74.19l82.59,75.71a8,8,0,0,0,10.82,0L216,74.19V192Z"></path></svg
            >Email
          </div>
        </a>
      </div>
