<script setup>
  import profilePicture from "$lib/public/profile picture.jpg";
  import logo from "$lib/public/logo.svg";
  ...
  function copyEmail() {
    navigator.clipboard.writeText("mohammedaban777@gmail.com");
    alert("Email Copied!");
  }
</script>
    ...
    <img
      ...
      <div class="max-[1000px]:items-center flex flex-col">
        ...
        <div
          ...
          >
          <button
            class="flex flex-row gap-2 cursor-pointer socialButton"
          ...
          <button class="flex flex-row gap-2 cursor-pointer socialButton" on:click|preventDefault={() => {
                  copyEmail()
                  }}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
